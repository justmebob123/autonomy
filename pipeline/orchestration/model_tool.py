...
This is a compatibility layer that provides the ModelTool and SpecialistRegistry
classes that were previously deleted but are still referenced in the codebase.
"""
