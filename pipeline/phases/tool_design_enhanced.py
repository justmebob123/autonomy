"""
Enhanced Tool Design Phase with Intelligent Analysis
...
class ToolDesignPhaseEnhanced(LoopDetectionMixin, BasePhase):
    """
    Enhanced phase for designing custom tools with intelligent analysis.
...
"""
    ...
    def generate_state_markdown(self, state: PipelineState) -> str:
        ...
        md = f"""# Enhanced Tool Design Phase State
