"""
Enhanced Function Call Validator V2

Eliminates false positives by:
- Understanding Python method calling (self parameter)
...
class FunctionCallValidatorV2:
    ...
    def _check_function_call(self, node: ast.Call, filepath: Path):
        ...
        stdlib_functions = {
            'parse', 'get', 'post', 'put', 'delete',  # Common HTTP/parsing
            'register', 'generate', 'consult_specialist',  # Common patterns
            'format', 'join', 'split', 'replace',  # String methods
        }
